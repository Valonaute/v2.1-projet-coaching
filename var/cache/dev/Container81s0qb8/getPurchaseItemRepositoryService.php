...
class getPurchaseItemRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PurchaseItemRepository.php';

        return $container->privates['App\\Repository\\PurchaseItemRepository'] = new \App\Repository\PurchaseItemRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
