...
class getOrderControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PDCmthl'] ?? $container->load('get_ServiceLocator_PDCmthlService'))->withContext('App\\Controller\\OrderController', $container));
