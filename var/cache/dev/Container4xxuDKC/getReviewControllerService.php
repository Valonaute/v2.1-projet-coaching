...
class getReviewControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.o6bgBvu'] ?? $container->load('get_ServiceLocator_O6bgBvuService'))->withContext('App\\Controller\\ReviewController', $container));
