...
class getOrderPaymentSuccessControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.PBaNnU7'] ?? $container->load('get_ServiceLocator_PBaNnU7Service'))->withContext('App\\Controller\\Order\\OrderPaymentSuccessController', $container));
