...
class getReviewControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.07CUcwQ'] ?? $container->load('get_ServiceLocator_07CUcwQService'))->withContext('App\\Controller\\ReviewController', $container));
