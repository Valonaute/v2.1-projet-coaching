...
class getCartControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.ILmuIG4'] ?? $container->load('get_ServiceLocator_ILmuIG4Service'))->withContext('App\\Controller\\CartController', $container));
