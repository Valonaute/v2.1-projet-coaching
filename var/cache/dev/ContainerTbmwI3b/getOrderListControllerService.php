...
class getOrderListControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.xXxsN9E'] ?? $container->load('get_ServiceLocator_XXxsN9EService'))->withContext('App\\Controller\\Order\\OrderListController', $container));
